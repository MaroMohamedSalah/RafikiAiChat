...
#     processed_patterns = [process_input(pattern).lower() for pattern in intent.get('patterns', [])]
#
#     # Debugging: Print some information to understand the logic flow
...
#     fuzzy_high_matches = fuzzy_match(processed_input, processed_patterns, fuzzy_threshold_high)
#     # print("Fuzzy High Matches:", fuzzy_high_matches)
#
...
#     fuzzy_low_matches = fuzzy_match(processed_input, processed_patterns, fuzzy_threshold_low)
#     # print("Fuzzy Low Matches:", fuzzy_low_matches)
#
...
#         return random.choice(intent.get("responses", ["I don't understand."]))
#
#     return None
